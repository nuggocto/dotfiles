...
> [SDK Setup](../sentry-sdk-setup/SKILL.md) > Cloudflare SDK
...
|------------------|--------------|
| Astro / static browser JS | `sentry-browser-sdk` |
| Svelte / SvelteKit | `sentry-svelte-sdk` |
| React / Next.js | Use the matching official Sentry framework docs |
