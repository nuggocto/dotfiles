...
> [SDK Setup](../sentry-sdk-setup/SKILL.md) > Browser SDK
...
|-------------------|-------------|
| `next` | Use the official Next.js docs — see [docs.sentry.io/platforms/javascript/guides/nextjs/](https://docs.sentry.io/platforms/javascript/guides/nextjs/) |
| `react` (without Next.js) | Use the official React docs — see [docs.sentry.io/platforms/javascript/guides/react/](https://docs.sentry.io/platforms/javascript/guides/react/) |
...
| `express` / `fastify` / `@nestjs/core` | This is a Node.js server — use [docs.sentry.io/platforms/javascript/guides/node/](https://docs.sentry.io/platforms/javascript/guides/node/) |
...
| Other backend | Use the matching official Sentry platform docs |
